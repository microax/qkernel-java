...
public class ValueObjectBuilder
{
    ...
    public static void main(String args[])
    {
        ...
        try
  	{
            bv = new ValueObjectBuilder(args[0], args[1], args[2], args[3] );
     ...
     */
    public ValueObjectBuilder(String driver, String url, String user, String pass) throws SQLException, ClassNotFoundException
    {
        this.url = url;
        this.driver = driver;
