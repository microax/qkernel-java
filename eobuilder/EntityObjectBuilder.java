...
public class EntityObjectBuilder
{
    ...
    public static void main(String args[])
    {
        ...
        String table = "";
        EntityObjectBuilder builder = new EntityObjectBuilder(args[0], args[1]);
        switch (args.length) {
            case 6:
                single = true;
                table = args[5];
     ...
     */
    public EntityObjectBuilder(String drv, String url)
    {
        this.url = url;
        this.driver = drv;
        try
	...
	else
	{
        ...
        switch (type)
    	{
            ...
            case Types.INTEGER:
                ...
                break;
            case Types.CHAR:
                retval = "'\").append(misc.sql.Convert.sqlSafe( " + retval + ")).append(\"'";
                break;
            case Types.VARCHAR:
                retval = "'\").append(misc.sql.Convert.sqlSafe( " + retval + ")).append(\"'";
                break;
