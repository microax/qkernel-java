package com.qkernel;
//
// SmsRemoteServiceQueue.java	A Mos class to Queue SmsRemote requests
// ----------------------------------------------------------------------------
// History:
// --------
...
public final class SmsRemoteServiceQueue extends Mos
{
    ...
    public SmsRemoteServiceQueue(String name, Daemon d, String rhost, int rport)
    {
	super(name, d);
